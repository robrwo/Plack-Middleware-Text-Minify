This is the Security Policy for the Perl distribution Plack-Middleware-Text-Minify.

The latest version of this Security Policy can be found at
https://metacpan.org/dist/Plack-Middleware-Text-Minify.
...
Any security vulnerabilities in Plack-Middleware-Text-Minify are covered
by this policy.
...
by this policy unless they affect Plack-Middleware-Text-Minify, or
Plack-Middleware-Text-Minify can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that
uses Plack-Middleware-Text-Minify, or plugins to it that are not included
with the Plack-Middleware-Text-Minify distribution) are not covered by
this policy.

## Which Versions of this Software are Supported?

The maintainer(s) will only commit to releasing security fixes for the
latest version of Plack-Middleware-Text-Minify.

Note that the Plack-Middleware-Text-Minify project only supports major
versions of Perl released in the past ten (10) years, even though
Plack-Middleware-Text-Minify will run on older versions of Perl.  If a
